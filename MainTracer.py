...
# path2= "/Volumes/deepak/nsexamples/"
...
def cal2(row):
        malicious = [2,7,0,1,25,16,28]
        if row["Node"] in malicious and row["Packet Drop Ratio"]  >= 0.400:  #need to add more nodes that are malicious
                val =1
        else : val = 0
        return val
